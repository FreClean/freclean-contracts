...
**FreClean**, Léogâne, Ouest, Haiti ("Supplier"), and

**______________________________** ("Buyer").

## 1. Term

This Agreement begins on the Effective Date and continues for **☐ 1 year ☐ 2 years ☐ 3 years ☐ 4 years** (select one), renewing automatically for successive one-year terms unless either party gives 60 days' written notice of non-renewal.
...
Products are supplied per their published specification (see each product's entry in `freclean-products`, including Safety Data Sheet once published). Buyer may return a defective or damaged shipment within 7 days of delivery for replacement or credit.
...
Each party's liability is limited to direct damages; neither party is liable for indirect or consequential damages, except for confidentiality breaches or willful misconduct.

## 8. Termination

- **For convenience:** either party may terminate with 60 days' written notice.
- **For cause:** immediate termination on written notice for uncured material breach (30-day cure period), including repeated late payment.

## 9. Confidentiality

Each party keeps the other's non-public business information (including pricing under this Agreement) confidential.
